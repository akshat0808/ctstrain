...
public class BookController {
	...
	@ExceptionHandler
	public ResponseEntity<ErrorMessage> handleError1 (BookNotFoundException bnfe){
		ErrorMessage errorMessage = new ErrorMessage();
		errorMessage.setMessage(bnfe.getMessage());
	...
	public Optional<Book> getBookById(@PathVariable Integer bookId) throws Exception
	{
		...
		if(!book.isPresent())
		{
			throw new BookNotFoundException("Aisi koi book nahi hai..!!: "+bookId);
		}
